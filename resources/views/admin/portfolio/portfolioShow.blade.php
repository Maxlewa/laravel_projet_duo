...
@section('content')
    ...
    <div class="mt-5">
        <div class="text-center ">
            <h1 class="titrePortfolioShow">Article PORTFOLIO</h1>
            <hr>
        </div>
        <div class="divContenu">
            <div class="contenuPart">
                <h2 class="h2portfolioShow">Titre</h2>
                <h3>{{$portfolio->titre}}</h3>
            </div>
            <div class="contenuPart">
                <h2 class="h2portfolioShow">Image</h2>
                <h3>{{$portfolio->image}}</h3>               
            </div>
            <div class="contenuPart">
                <h2 class="h2portfolioShow">Texte</h2>
                <p>{{$portfolio->texte}}</p>
            </div>
        </div>
        <div class="threeBtn">
            <a href="{{route('portfolioArticle.edit', $portfolio->id)}}"><button class="btn btn-edit mx-1">Edit</button></a>
